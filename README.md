...
#### 2. 기획 배경
- 요즘 MZ세대에게 MBTI, 퍼스널 컬러, 학과 탐색, 포레스트 엠티 등의 테스트들이 유행하고 있음
...
<img width="708" alt="20220518054628" src="https://user-images.githubusercontent.com/96553431/168907140-88056420-2f2e-4104-b7fd-45a201439503.png">
#### 4. 기대 효과
...
- 딥러닝 분석 : 패션 이미지를 학습한 딥러닝 모델이 사용자의 사진에서 스타일을 분류
    - 8개 카테고리로 정확도를 %로 반환
- 결과 출력 : 분류 결과를 코멘트와 함께 시각화하여 흥미있고, 직관적으로 제공
- 공유 :시각화된 결과와 사진을 페이스북, 카카오톡 등 SNS에 공유
- 데이터 분석 : 성별, 연령별, 기간별 스타일 트렌드 대시보드 제공
