...
fig_tot_style.update_traces(hole=.35, hoverinfo="label+percent+name", textinfo='label')
...
fig_gender.update_traces(hole=.35, hoverinfo="label+percent+name", textinfo='label')  # textinfo='label+percent'
...
fig.update_traces(hole=.35, hoverinfo="label+percent+name", textinfo='label')
